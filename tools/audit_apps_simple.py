...
APP_DIRS = [
  "2025-08-uc-app-v1-v1",
  "2025-08-uc-conversational-app-v1-v1", 
  "2025-08-conversational-ucid-app-conversational",
  "2025-05-id-career-sorter",
  "2025-04-id-career-sorter-v2-v2",
]
...
def proposed_name(app_name, created_iso, suffix_hint=None):
...
def main():
  root = "/Users/johnviolette/Library/Mobile Documents/com~apple~CloudDocs/Insanity Folder/UC | App Design Master"
  ...
  results = []
  for app in APP_DIRS:
    src = os.path.join(projects_root, app)
