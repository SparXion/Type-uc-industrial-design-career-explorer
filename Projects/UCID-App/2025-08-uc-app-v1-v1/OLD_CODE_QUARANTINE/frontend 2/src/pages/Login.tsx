...
const Login: React.FC = () => {
  ...
  const { state, setLoading, setError, clearError } = useAppContext();
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!registerData.username || !registerData.email || !registerData.password) {
      console.log('❌ Form validation failed:', { username: !!registerData.username, email: !!registerData.email, password: !!registerData.password });
      setError('Please fill in all fields');
      return;
    }
    ...
    try {
      ...
      console.log('🌐 API URL will be:', `${process.env.REACT_APP_API_URL || 'http://localhost:5001/api'}/auth/register`);
